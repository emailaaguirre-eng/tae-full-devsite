...
export const ELEGANT_TEMPLATES: ArtKeyTemplate[] = [
  {
    ...
    description: 'Blush and champagne layering with soft, graceful accents for wedding portals.',
    bg: 'linear-gradient(165deg, #FFF7F8 0%, #FDE7EC 52%, #F7E8DC 100%)',
    button: '#B76E79',
    text: '#4A3F42',
    title: '#9F4F5F',
    category: 'elegant',
  ...
  {
    value: 'vintage-charm',
    name: 'Memorial / Soft Tribute',
    description: 'Warm stone tones and calm contrast designed for respectful tribute pages.',
    bg: 'linear-gradient(170deg, #FCF7F1 0%, #EFE2D5 60%, #E7D8C7 100%)',
    button: '#6B5A4B',
    text: '#4B4038',
    title: '#3F352F',
    category: 'elegant',
  ...
  },
  {
    value: 'aurora',
    name: 'Modern Luxe',
    description: 'Deep jewel layering with polished metallic contrast for premium events.',
    bg: 'linear-gradient(160deg, #221F3B 0%, #3B2C6D 48%, #5A3D8A 100%)',
    button: '#E9D5FF',
    text: '#F3E8FF',
    title: '#F5E9C9',
    category: 'elegant',
  ...
  },
  {
    ...
    description: 'Refined light palette with subtle depth and clean editorial balance.',
    bg: 'linear-gradient(180deg, #FAFBFC 0%, #EEF2F7 100%)',
    button: '#334155',
    text: '#1F2937',
    title: '#0F172A',
    category: 'elegant',
