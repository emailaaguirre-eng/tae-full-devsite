...
import { getDb, saveDatabase, shopCategories, shopProducts, eq } from '@/lib/db';
...
export async function PUT(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const allowedFields = ['name', 'slug', 'icon', 'taeBaseFee', 'requiresQrCode', 'active', 'featured', 'sortOrder', 'printfulProductId'];
